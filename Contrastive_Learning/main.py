...
def tf_noise_aug(input_image):
    ...
    noisy_img = tf.cast(tf.round(noisy_img),dtype=tf.int32)
...
if __name__ == "__main__":
    ...
    net.fit(x = train_dataset,epochs=epoch_num,validation_data=test_dataset,validation_freq = 10,callbacks = callback_list)
